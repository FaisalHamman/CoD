...
for dataset in "${datasets[@]}"; do
  for subset_size in "${subset_sizes[@]}"; do
    for seed in "${SEEDS[@]}"; do
      # KD_clean experiment
      commands+=("${student_model}|teacher_models/${teacher_model}/${dataset}/teacher_init|ted-deberta-v2|${dataset}|${batch_size}|256|2e-5|50|0|7|20|0|filter_disabled|./ted_output/${student_model}/${dataset}/seed${seed}/kd|fp16|save_best|${subset_size}|clean|with_tracking|${seed}")
      # LWD_clean experiment
      commands+=("${student_model}|teacher_models/${teacher_model}/${dataset}/teacher_init|ted-deberta-v2|${dataset}|${batch_size}|256|2e-5|50|0|7|20|0.05|filter_disabled|./ted_output/${student_model}/${dataset}/seed${seed}/lwd|fp16|save_best|${subset_size}|clean|with_tracking|${seed}")
      # KD_cfx experiment
      commands+=("${student_model}|teacher_models/${teacher_model}/${dataset}/teacher_init|ted-deberta-v2|${dataset}|${batch_size}|256|2e-5|50|0|7|20|0|filter_disabled|./ted_output/${student_model}/${dataset}/seed${seed}/kd|fp16|save_best|${subset_size}|cfx|with_tracking|${seed}")
      # LWD_cfx experiment
      commands+=("${student_model}|teacher_models/${teacher_model}/${dataset}/teacher_init|ted-deberta-v2|${dataset}|${batch_size}|256|2e-5|50|0|7|20|0.05|filter_disabled|./ted_output/${student_model}/${dataset}/seed${seed}/lwd|fp16|save_best|${subset_size}|cfx|with_tracking|${seed}")
    done
  done
done
